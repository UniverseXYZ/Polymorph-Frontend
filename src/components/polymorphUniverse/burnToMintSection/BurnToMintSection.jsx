  ...
  return (
    <>
      <AnimatedOnScroll animationIn="fadeIn" animationInDelay={200}>
        <h2>Burn To Mint</h2>
        <p>
          Polymorph holders are invited to burn their original NFTs to mint
          brand new ones. The same Polymorphs you know and love but with brand
          new possibilities.
        </p>
        <Button
